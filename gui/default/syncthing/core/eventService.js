...
angular.module('syncthing.core')
    .service('Events', ['$http', '$rootScope', '$timeout', function ($http, $rootScope, $timeout) {
        ...
        function successFn(data) {
            // When Ark Sync restarts while the long polling connection is in
        ...
        angular.extend(self, {
            ...
            CONFIG_SAVED: 'ConfigSaved',   // Emitted after the config has been saved by the user or by Ark Sync itself
            ...
            ITEM_FINISHED: 'ItemFinished',   // Generated when Ark Sync ends synchronizing a file to a newer version
            ITEM_STARTED: 'ItemStarted',   // Generated when Ark Sync begins synchronizing a file to a newer version
            ...
            STARTING: 'Starting',   // Emitted exactly once, when Ark Sync starts, before parsing configuration etc
            STARTUP_COMPLETED: 'StartupCompleted',   // Emitted exactly once, when initialization is complete and Ark Sync is ready to start exchanging data with other devices
